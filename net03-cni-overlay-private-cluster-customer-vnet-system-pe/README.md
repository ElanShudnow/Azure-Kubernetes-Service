...
3. Execute the commands in the script.
    ...
    ![Variables-01](../media/net03-cni-overlay-private-cluster-customer-vnet-system-pe/variables01.png)

    ![Variables-02](../media/net03-cni-overlay-private-cluster-customer-vnet-system-pe/variables02.png)

    ![Variables-03](../media/net03-cni-overlay-private-cluster-customer-vnet-system-pe/variables03.png)

    ![Variables-04](../media/net03-cni-overlay-private-cluster-customer-vnet-system-pe/variables04.png)

    #### Create Resource Group

    ![ResourceGroup-Creation](../media/net03-cni-overlay-private-cluster-customer-vnet-system-pe/resourcegroup.png)

    #### Create Virtual Network/Subnet

    ![VirtualNetwork-Creation](../media/net03-cni-overlay-private-cluster-customer-vnet-system-pe/virtualnetwork.png)

    #### Capture Node Subnet ID for AKS Nodes to be deployed within

    ![VNET-NodeSubnetID](../media/net03-cni-overlay-private-cluster-customer-vnet-system-pe/nodesubnetid.png)

    #### Deploy AKS Cluster

    ![AKS Deployment](../media/net03-cni-overlay-private-cluster-customer-vnet-system-pe/aksdeploy.png)
...
![JSON View 01](../media/net03-cni-overlay-private-cluster-customer-vnet-system-pe/jsonview01.png)
...
![JSON View 02](../media/net03-cni-overlay-private-cluster-customer-vnet-system-pe/jsonview02.png)
...
![Kubectl Get Nodes Failure](../media/net03-cni-overlay-private-cluster-customer-vnet-system-pe/kubectlfailure.png)
...
![Kubectl Get Nodes](../media/net03-cni-overlay-private-cluster-customer-vnet-system-pe/kubectlgetnodes.png)
...
![Quickstart Deploy](../media/net03-cni-overlay-private-cluster-customer-vnet-system-pe/quickstartdeploy.png)
...
![Kubectl Get Service](../media/net03-cni-overlay-private-cluster-customer-vnet-system-pe/kubectlgetservice.png)
...
![Kubectl Get Pod](../media/net03-cni-overlay-private-cluster-customer-vnet-system-pe/kubectlgetpods.png)
...
![Kubectl Get Single Node POD CIDR](../media/net03-cni-overlay-private-cluster-customer-vnet-system-pe/kubectlgetnodepodcidr.png)
...
![Kubectl Get Single Node POD CIDR](../media/net03-cni-overlay-private-cluster-customer-vnet-system-pe/kubectlgetnodespodcidr.png)
...
![JSON View 03](../media/net03-cni-overlay-private-cluster-customer-vnet-system-pe/jsonview03.png)
...
![Kubectl Get Credentials](../media/net03-cni-overlay-private-cluster-customer-vnet-system-pe/kubectlgetcreds.png)
